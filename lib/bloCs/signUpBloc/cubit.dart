import 'package:exam_system/bloCs/signUpBloc/states.dart';
...
class SingUpBloc extends Cubit<SignUpStates> {
  SingUpBloc(this.context) : super(InitialState());

  var context;

  static SingUpBloc get(context) => BlocProvider.of(context);
  ...
  Future<void> loading() async {
    if (password.value.text != confirmPassword.value.text) {
      ...
      QuickAlert.show(
          ...
          title: "Warning",
          text: "Make Sure that Password and Confirm Password Identical",
          confirmBtnText: "ok",
          onConfirmBtnTap: (){
